...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['File'])) {
    ...
    if ($excelFile['error'] === UPLOAD_ERR_OK) {
        ...
        $targetFileName = $targetDirectory . uniqid('excel_', true) . '.' . pathinfo($excelFile['name'], PATHINFO_EXTENSION);

        // Move the uploaded file to the target directory
        if (move_uploaded_file($excelFile['tmp_name'], $targetFileName)) {
            // Load the Excel file
            $spreadsheet = IOFactory::load($targetFileName);

            // Create a TCPDF writer
            ...
            // Delete the temporary Excel and generated PDF files
        ...
        echo "File upload failed with error code: " . $excelFile['error'];
    }
} else {
}
?>
...
<head>
    ...
    <title>ToconvertExceltoPDF</title>
    <link rel="stylesheet" href="main.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css" integrity="sha512-z3gLpd7yknf1YoNbCzqRKc4qyor8gaKU1qmn+CShxbuBusANI9QpRohGBreCFkKxLhei6S9CQXFEbbKuqLg0DA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <script src="https://code.jquery.com/jquery-3.6.4.min.js" integrity="sha256-oP6HI/tTmeKcJ3pNl+fsA8svaWjV5eqK6Qr7I8Z3KaA=" crossorigin="anonymous"></script>
</head>
        ...
        <div class="main-div-converter">
            ...
            <div class="main-div-converter-2">
                ...
                <div class="button-div-converter">
                    <form id="uploadForm" action="ToconvertExceltoPDF.php" method="post" enctype="multipart/form-data">
                        <input type="file" name="File" accept=".xls, .xlsx" onchange="displayFileName(this)" />
