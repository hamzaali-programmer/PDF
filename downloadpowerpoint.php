...
<head>
    ...
    <title>DownloadPOWERPOINT</title>
...
<body>
    ...
    <section class="main-container">
        <div class="first-div download-first-div">
            <h3>POWERPOINT file has been converted to PDF</h3>
        </div>

        <div class="second-div">
            <div class="button-div">
                <a href="" class="btn-upload">Download PDF
                    <input type="file" accept=".pptx" id="fileInput">
                </a>
            </div>
            <div class="icon-div">
