...
<body>
    ...
    <section class="main-container">
        <div class="first-div">
            <h1>JPG to PDF</h1>
            <h3>Convert JPG images to PDF in seconds. Easily adjust orientation and margins.</h3>
        </div>

        <div class="second-div">
            <div class="button-div">
                <a href="ToconvertimagetoPDF.php" class="btn-upload">Select JPG file
                </a>
            </div>
            <div class="icon-div">
                <a href="">
        ...
        <p id="specific">or drop JPG images here</p>
    </section>
