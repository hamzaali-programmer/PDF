...
<body>
    ...
    <section class="main-container">
        <div class="first-div">
            ...
            <h3>Reduce file size while optimizing for maximal PDF quality.</h3>
        </div>

        <div class="second-div">
            <div class="button-div">
                <a href="compressPDF.php" class="btn-upload">Select PDF file
                </a>
            </div>
            <div class="icon-div">
        ...
        <p id="specific">or drop WORD documents here
            No file chosen</p>
