...
<body>
    ...
    <section class="main-container">
        <div class="first-div">
            ...
            <h3>Make PPT and PPTX slideshows easy to view by converting them to PDF.</h3>
        </div>

        <div class="second-div">
            <div class="button-div">
                <a href="ToconvertPowerPointtoPDF.php" class="btn-upload">Select PowerPoint file
                </a>
            </div>
            <div class="icon-div">
        ...
        <p id="specific">or drop POWERPOINT slideshows here
            No file chosen</p>
