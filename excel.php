...
<body>
    ...
    <section class="main-container">
        <div class="first-div">
            ...
            <h3>Make EXCEL spreadsheets easy to read by converting them to PDF.</h3>
        </div>
        
            <div class="second-div">
            <form action="ToconvertExceltoPDF.php" method="post" enctype="multipart/form-data">
                <div class="button-div">
                    <a href="ToconvertExceltoPDF.php" class="btn-upload">Select EXCEL file </a>
                </div>
            </form>
                <div class="icon-div">
            ...
            <p id="specific">or drop EXCEL spreadsheets here</p>
